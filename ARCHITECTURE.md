...
O schema completo está na migration inicial `000001_init`. Antes da primeira entrega, ela pode ser ajustada diretamente; após entrar em produção, deve permanecer imutável e mudanças futuras devem usar novas migrations versionadas.
