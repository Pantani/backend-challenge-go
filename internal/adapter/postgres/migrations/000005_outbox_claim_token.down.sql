...
-- Validate after the structural rollback commits for the same lock behavior
-- in both migration directions.
ALTER TABLE outbox_events VALIDATE CONSTRAINT outbox_events_lease_pair;
